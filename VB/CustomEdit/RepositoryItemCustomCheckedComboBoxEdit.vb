...
Namespace CustomEdit
	...
	Public Class RepositoryItemCustomCheckedComboBoxEdit
		...
		Public Shared Sub Register()
            EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(EditorName, GetType(CustomCheckedComboBoxEdit), GetType(RepositoryItemCustomCheckedComboBoxEdit), GetType(PopupContainerEditViewInfo), New ButtonEditPainter(), True))
		End Sub
		...
		Public Overrides Overloads Sub Assign(ByVal item As RepositoryItem)
			BeginUpdate()
			Try
				MyBase.Assign(item)
